export default function TermsAndConditions() {
  return (
    <div className="container prose min-w-full p-12">
      <h1>利用規約</h1>
      <p>
        この利用規約（以下，「本規約」といいます。）は、特定非営利活動法人グランドワークこしみずが提供する「Hottus」サービス（以下、「本サービス」といいます。）の利用条件を定めるものです。利用者のみなさまには、本規約に従って，本サービスをご利用いただきます。{' '}
      </p>
      <h2>第1条（適用）</h2>
      <ol>
        <li>本規約は、ユーザーと特定非営利活動法人グランドワークこしみずとの間の本サービスの利用に関わる一切の関係に適用されるものとします。</li>
        <li>
      ...
      <ol>
        ...
        <li>本サービスに関して紛争が生じた場合には、特定非営利活動法人グランドワークこしみずの本店所在地を管轄する裁判所を専属的合意管轄とします。</li>
      </ol>
      <p>以上</p>
    </div>
  );
